      ...
      setData({
        ...
        securityReport:
          securityReport.status === 'fulfilled' && securityReport.value.success
            ...
            : null,
        allAdmins:
          admins.status === 'fulfilled' && admins.value.success ? admins.value.data : null,
        auditLogs:
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center mb-4">
                    <p className="text-sm text-gray-600">
                      Total Admins: {data.allAdmins.length}
                    </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{data.systemConfig.security?.maxLoginAttempts}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Session Timeout</span>
                        <span className="font-medium">{data.systemConfig.security?.sessionTimeout}min</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">
                            {log.targetType} • {log.ipAddress} • {new Date(log.timestamp).toLocaleString()}
                          </p>
                        </div>
                      </div>
                    </div>
