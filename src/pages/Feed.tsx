...
const mockPosts: Post[] = [
  {
    _id: '1',
    content: 'Just shipped a new feature! 🚀 Really excited about the improvements to user experience. What do you think about the new design patterns in modern web development?',
    author: {
      _id: 'user1',
      username: 'johndoe',
      firstName: 'John',
  ...
  {
    _id: '2',
    content: 'Beautiful sunset today! 🌅 Sometimes it\'s important to take a break from coding and appreciate the world around us.',
    author: {
      _id: 'user2',
      username: 'sarahsmith',
      firstName: 'Sarah',
  ...
  {
    _id: '3',
    content: 'Working on a new React component library. The developer experience is so much better with TypeScript! Anyone else loving the type safety?',
    author: {
      _id: 'user3',
  ...
  {
    _id: '4',
    content: 'Quick quiz: Which of these languages do you use the most? 🤔\n1. JavaScript\n2. Python\n3. Java\n4. Go',
    author: {
      _id: 'user4',
      username: 'quizmaster',
      firstName: 'Alice',
  ...
  {
    _id: '5',
    content: 'Morning motivation 🌞: "Do one thing every day that scares you." – Eleanor Roosevelt',
    author: {
      _id: 'user5',
  ...
  {
    _id: '7',
    content: 'What’s your preferred way of learning? 📚\n- Online courses\n- YouTube tutorials\n- Books\n- Bootcamps',
    author: {
      _id: 'user7',
      username: 'learnerhub',
      firstName: 'Sophia',
  ...
  {
    _id: '8',
    content: 'Finally deployed my first Dockerized app with Nginx reverse proxy! 🔥 Anyone want me to write a tutorial?',
    author: {
      _id: 'user8',
  ...
  {
    _id: '9',
    content: 'Which one do you prefer for backend? ⚡️\n1. Node.js\n2. Django\n3. Spring Boot\n4. FastAPI',
    author: {
      _id: 'user9',
      username: 'techquiz',
      firstName: 'Elena',
  ...
  {
    _id: '10',
    content: 'Travel throwback ✈️🇮🇹 Rome is still one of the most beautiful cities in the world!',
    author: {
      _id: 'user10',
      username: 'wanderlust',
      firstName: 'Maria',
      lastName: 'Giovanni',
      avatar: 'https://images.unsplash.com/photo-1544725176-7c40e5a2c9f9?w=400&h=400&fit=crop&crop=face'
    },
    likesCount: 500,
    commentsCount: 88,
    repostsCount: 21,
  ...
  {
    _id: '11',
    content: 'Daily coding challenge: Reverse a linked list in O(n) time. 🚀 Post your solutions!',
    author: {
      _id: 'user11',
      username: 'coderdaily',
      firstName: 'Ibrahim',
      lastName: 'Ahmed',
      avatar: 'https://images.unsplash.com/photo-1546525848-3ce03ca516f6?w=400&h=400&fit=crop&crop=face'
    },
    likesCount: 76,
    commentsCount: 19,
    repostsCount: 6,
  ...
  {
    _id: '14',
    content: 'Quick poll: Which cloud provider do you use? ☁️\n- AWS\n- Azure\n- Google Cloud\n- Other',
    author: {
      _id: 'user14',
      username: 'cloudman',
      firstName: 'Victor',
  ...
  },
  {
    ...
    author: {
      ...
      firstName: 'Priya',
      lastName: 'Singh',
      avatar: 'https://images.unsplash.com/photo-1502767089025-6572583495b0?w=400&h=400&fit=crop&crop=face'
    },
    likesCount: 420,
    commentsCount: 82,
    repostsCount: 40,
  ...
  },
  {
    ...
    media: ['https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&h=600&fit=crop'],
  ...
  },
  {
    ...
    media: ['https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&h=600&fit=crop'],
